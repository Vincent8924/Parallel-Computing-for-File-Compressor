...
namespace UZipDotNet.ConsoleApp.net452
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Print beautifully formatted CPU performance report
            Console.WriteLine("\n========================================");
            ...
            try
            {
                using (var inf = new InflateZipFile(filepath))
                {
                    ...
                    for (int i = 0; i < totalFiles; i++)
                    {
                        ...
                        {
                            // Clear line before printing warning so it doesn't mess up progress bar
