...
// ILGPU Namespaces required for GPU Parallelism
using ILGPU;
using ILGPU.Runtime;
...
namespace pdj.tiny7z
{
    class Program
    {
        // Buffer to hold our pre-loaded and GPU-processed data
        ...
        // =================================================================
        // THE GPU KERNEL (Executes entirely inside the Graphics Card VRAM)
        // =================================================================
        static void GpuEncryptionKernel(Index1D index, ArrayView<byte> dataView, byte cryptoKey)
        {
            // Simple highly-parallel operation: XOR Encryption
            // Each GPU core encrypts exactly one byte independently without locking
            dataView[index] = (byte)(dataView[index] ^ cryptoKey);
        }

        // =================================================================
        // FUNCTION 1: SMART HETEROGENEOUS GPU COMPRESSION PIPELINE (FIXED)
        // =================================================================
        ...
        // =================================================================
        // FUNCTION 2: ASYNCHRONOUS TASK DECOMPRESSION
        // =================================================================
        ...
        // =================================================================
        // UTILITIES: Standardized Progress Bar & Reporting Engine
        // =================================================================
